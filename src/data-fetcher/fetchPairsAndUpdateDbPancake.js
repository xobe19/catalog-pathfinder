...
function getCallsForPairDetails(pairAddress) {
    return [
        (0, multicall_1.prepareCall)(pairAddress, "getReserves", "function getReserves() external view returns (uint112 _reserve0, uint112 _reserve1, uint32  _blockTimestampLast)"),
...
async function main() {
    ...
    const pairAddressesFilePath = path_1.default.join(__dirname, "../../data", "pancakeswapPairs.txt");
    try {
